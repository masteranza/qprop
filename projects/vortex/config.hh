...
#define MOMENTA_DATA //Captures additional wf data for using ISURFV and (heuristically) TSURFF
// #define EXTRA_TIME_TSURFF_ONLY //Activates longer propagation for proper TSURFF (old technique), MOMENTA_DATA also needs to be active
...
void configPulse()
{
  ...
  vecpot_x = new TwoSinEnvSin2_vecpot(omega1, omega2, n1x, n2x, delay2, mult * E1x, mult * E2x, phase1x, phase2x);
  vecpot_y = new TwoSinEnvSin2_vecpot(omega1, omega2, n1y, n2y, delay2, mult * E1y, mult * E2y, phase1y, phase2y);
