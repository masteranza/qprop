...
double hamop::vecpot_x(double time, int me)
{
  ...
  if (std::isnan(result))
    fprintf(stderr, "err: hamop::vecpot_x() is nan!");
  return result;
};
...
double hamop::vecpot_y(double time, int me)
{
  ...
  if (std::isnan(result))
    fprintf(stderr, "err: hamop::vecpot_y() is nan!");
  return result;
};
...
double hamop::vecpot_z(double time, int me)
{
  ...
  if (std::isnan(result))
    fprintf(stderr, "err: hamop::vecpot_z() is nan!");
  return result;
};
...
double hamop::scalarpot(double x, double y, double z, double time, int me)
{
  ...
  if (std::isnan(result))
    fprintf(stderr, "err: hamop::scalarpot() is nan!");
  return result;
}
...
double hamop::scalarpotx(double x, double y, double z, double time, int me)
{
  ...
  result = hamopscalarpotx(x, y, z, time, me);
  if (std::isnan(result))
    fprintf(stderr, "err: hamop::scalarpotx() is nan!");
  return result;
};
...
double hamop::imagpot(long xindex, long yindex, long zindex, double time, grid g)
{
  ...
  if (std::isnan(result))
    fprintf(stderr, "err: hamop::imagpot() is nan!");
  return result;
}
...
//   if (std::isnan(result))
//     fprintf(stderr, "err: hamop::field() is nan!");
//   return result;
// }
